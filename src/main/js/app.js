...
class Application extends React.Component {
  ...
  onMouseClick(e) {
    ...
    client({
      ...
      console.log(this.selectedCountryContains(country.id));
      if (this.selectedCountryContains(country.id)) {
        // unfill it
        console.log("Country in here");
        let paths = d3.select("#worldMapSVG").selectAll("." + countryName);
        paths.style("fill", "#ececec");
        let selectedCountry = this.state.selectedCountries.find(c => c.get("id") === country.id);
        this.state.selectedCountries = this.state.selectedCountries.delete(selectedCountry);
        this.setState ({
          selectedCountryArea: this.calculateSelectedArea()
        });

        console.log("Selected coountries:");
      ...
      <div ref="elem" className="container">
        ...
        >
          ...
          <path
            ...
            id="VC"
            className="Saint Vincent and the Grenadines"
          ></path>
          <path
            d="M626.1 383.4l-0.4 0.2-0.1 0-0.3 0.2-0.1-0.1 0.1-0.3 0.6-0.1 0.2 0.1z"
            id="VG"
            className="British Virgin Islands"
          ></path>
          <path
          ...
          <path
            ...
            id="BQSE"
            className="St. Eustatius (Netherlands)"
          ></path>
          <path
            d="M632.8 388.7l-0.1 0 0.1-0.2 0.1 0.1-0.1 0.1z"
            id="BQSA"
            className="Saba (Netherlands)"
          ></path>
          <path
