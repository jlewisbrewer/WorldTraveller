...
const { Set, fromJS, isValueObject } = require("immutable");
const d3 = require("d3");
...
class Application extends React.Component {
  constructor(props) {
    ...
    this.countries = {
      ...
      Bangladesh: 148460,
      Bulgaria: 110993,
      Bosnia_and_Herzegovina: 51129,
      Belarus: 207595,
      Belize: 22966,
      Bolivia: 1098581,
      Brazil: 8515767,
      Brunei_Darussalam: 5765,
      Bhutan: 38394,
      Botswana: 581730,
      ...
      Switzerland: 41285,
      China: 9596961,
      "Côte_d'Ivoire": 322463,
      Cameroon: 475442,
      Democratic_Republic_of_the_Congo: 2345409,
      Republic_of_Congo: 342000,
      Colombia: 1141748,
      Costa_Rica: 51100,
      Cuba: 109884,
      ...
      Netherlands: 41865,
      Portugal: 92226,
      Russian_Federation: 17098246,
      Spain: 505990,
      France: 640679,
      United_States: 9833524,
      French_Guiana: 83534,
      Aruba: 193,
      Anguilla: 91,
      American_Samoa: 199,
      Antigua_and_Barbuda: 440,
      Bahrain: 780,
      Bahamas: 13878,
      "Saint-Barthélemy": 25,
      Bermuda: 53,
      ...
      Palau: 459,
      Puerto_Rico: 9104,
      French_Polynesia: 4167,
      Solomon_Islands: 28400,
      São_Tomé_and_Principe: 1001,
      Sint_Maarten: 34,
      Seychelles: 459,
      Turks_and_Caicos_Islands: 616,
      Tonga: 748,
      Trinidad_and_Tobago: 5131,
      Tuvalu: 26,
      Saint_Vincent_and_the_Grenadines: 389,
      British_Virgin_Islands: 153,
      United_States_Virgin_Islands: 346,
      Vanuatu: 12189,
      Samoa: 2842,
      "St._Eustatius": 21,
      Saba: 13,
  ...
  onMouseClick(e) {
    let country = e.target.className.baseVal;

    let landArea = this.countries[country];
    if (landArea) {
      if (this.state.selectedCountries.includes(country)) {
        // unfill it
        let paths = d3.select("#worldMapSVG").selectAll("." + country);
        paths.style("fill", "#ececec");

        this.state.selectedCountries = this.state.selectedCountries.filter((value, ind, arr)=>{
          return value !== country;
        });
        this.state.selectedCountryArea -= this.countries[country]
        this.setState({
          selectedCountryPercentage: this.calculateSelectedCountryPercentage(),
        });
      } else {
        // fill
  ...
  calculateSelectedCountryPercentage() {
    return Math.round((this.state.selectedCountryArea / this.state.totalArea) * 10000) / 100;
  }

  componentDidMount() {}

  render() {
    const selectedCountryPercentage = this.state.selectedCountryPercentage;
      ...
      <div ref="elem" className="container">
        ...
        >
          ...
          <path
            ...
            id="AE"
            className="United_Arab_Emirates"
          ></path>
          <path
            className="Argentina"
          ...
          <path
            ...
            id="BA"
            className="Bosnia_and_Herzegovina"
          ></path>
          <path
          ...
          <path
            ...
            id="CF"
            className="Central_African_Republic"
          ></path>
          <path
            className="Canada"
          ...
          <path
            ...
            id="ZA"
            className="South_Africa"
          ></path>
          <path
            className="New_Zealand"
          ...
          ></path>
          <path
            className="Federated_States_of_Micronesia"
          ...
          ></path>
          <path
            className="Saint_Kitts_and_Nevis"
          ...
          ></path>
          <path
            className="Northern_Mariana_Islands"
          ...
          ></path>
          <path
            className="São_Tomé_and_Principe"
          ...
          ></path>
          <path
            className="Turks_and_Caicos_Islands"
          ...
          <path
            ...
            id="VC"
            className="Saint_Vincent_and_the_Grenadines"
          ></path>
          <path
            d="M626.1 383.4l-0.4 0.2-0.1 0-0.3 0.2-0.1-0.1 0.1-0.3 0.6-0.1 0.2 0.1z"
            id="VG"
            className="British_Virgin_Islands"
          ></path>
          <path
            className="United_States_Virgin_Islands"
        ...
        <h3>You have visited {selectedCountryPercentage}% of the world!</h3>
      </div>
    );
  }
}
